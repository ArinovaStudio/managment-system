                  ...
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-xs text-gray-500 dark:text-gray-400">({fb.message})</span>
                      </div>
                    </div>
            ...
            <div className="flex justify-end mb-4">
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  className={`w-12 h-6 flex items-center rounded-full p-1 cursor-pointer transition-all duration-300 ${anonymous ? "bg-gray-700" : "bg-gray-300"
                    }`}
                >
                  <motion.div
                    layout
                    transition={{ type: "spring", stiffness: 700, damping: 30 }}
                    className={`w-5 h-5 rounded-full shadow-md transform transition-transform duration-300 ${anonymous ? "translate-x-6 bg-white" : "translate-x-0 bg-gray-700"
                      }`}
                  />
                </div>
              </div>
          ...
          >
              ...
              <div className="flex items-center gap-4">
                {[1, 2, 3, 4, 5].map((num) => (
                  <motion.button
                    ...
                    className={`w-9 h-9 rounded-full border text-sm font-medium transition-all ${rating === num
            ...
            <div className="flex justify-end">
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className={`px-6 py-2.5 rounded-lg transition-colors flex items-center gap-2 ${isAdmin
