                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {leaveRequests.map((req) => {
                            ...
                            return (
                                <div
                                    key={req.id}
                                    className="p-4 border rounded shadow-sm bg-white dark:bg-gray-900 dark:border-gray-700 min-w-[500px]"
                                >
                                    {/* TOP SECTION */}
                                    <div className="">
                                        <div className="image flex gap-5">
                                            <Image src={req.user?.image} alt="Profile" width={70} height={70} className="object-cover rounded-full h-17 w-17" />
                                            ...
                                            <div className="mt-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg shadow">
                                                ...
                                                <div className="flex  justify-end gap-4">
                                                    <button
                                                        ...
                                                        className="mt-2 bg-[#d9f2e5] dark:text-gray-700 px-3 py-1 rounded-xl">
                                                        Approve
                                                    </button>

                                                    <button onClick={() => updateLeaveStatus(req.id, "Rejected")} className="mt-2 bg-[#ffe0dd] dark:text-gray-700 px-3 py-1 rounded-xl">
                                                        Deny
                                                    </button>
                                                </div>
